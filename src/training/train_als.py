...
def train_als_model(spark: SparkSession):
    ...
    logger.info(f"    Precision@5: {val_metrics['precision@5']:.4f}")
    logger.info(f"    Precision@10: {val_metrics['precision@10']:.4f}")
    logger.info(f"    Precision@20: {val_metrics['precision@20']:.4f}")
    logger.info(f"    Recall@5: {val_metrics['recall@5']:.4f}")
    logger.info(f"    Recall@10: {val_metrics['recall@10']:.4f}")
    logger.info(f"    Recall@20: {val_metrics['recall@20']:.4f}")
    ...
    logger.info("  Ranking Metrics:")
    logger.info(f"    Precision@5: {test_metrics['precision@5']:.4f}")
    logger.info(f"    Precision@10: {test_metrics['precision@10']:.4f}")
    logger.info(f"    Precision@20: {test_metrics['precision@20']:.4f}")
    logger.info(f"    Recall@5: {test_metrics['recall@5']:.4f}")
    logger.info(f"    Recall@10: {test_metrics['recall@10']:.4f}")
    logger.info(f"    Recall@20: {test_metrics['recall@20']:.4f}")
